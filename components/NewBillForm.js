                  ...
                  <div className="border-t border-gray-100 p-3 bg-gray-50 space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 text-xs font-semibold bg-gray-100 text-white px-3 py-2 rounded-lg hover:bg-gray-700"
                      >
                        सूची में भी जोड़ें
                      </button>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {paymentMethods.map((v) => (
                <button
                  ...
                  className={`py-2 rounded-lg text-sm font-semibold border transition-all ${payment === v ? "bg-gray-800 text-white border-gray-800" : "bg-white text-gray-600 border-gray-200 hover:border-gray-400"}`}
                >
                  {v}
                </button>
              ))}
